    ...
    const sideList = (
      <div className={classes.list}>
        <div className="navbar-drawer-header">
          ...
          <div className="navbar-drawer-text">TestowyProjekt</div>
        </div>
        <Divider />
        <List>
          {/* START LINK MENU */}
           ...
           <Link to="/debtors">
            <ListItem button key="Debtor">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="Debtor" />
            </ListItem>
          </Link>{" "}            
           <Link to="/documents">
            <ListItem button key="Document">
              ...
              <ListItemText className="menu-text" primary="Document" />
            </ListItem>
          </Link>{" "}            
           <Link to="/users">
           ...
           <Link to="/vindicationcases">
            <ListItem button key="VindicationCase">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="VindicationCase" />
            </ListItem>
          </Link>{" "} {/* END LINK MENU */}
        </List>
      </div>
