        ...
        <Table>
          <TableHead>
            <TableRow>
              ...
              <TableCell align="right">AnswerDate</TableCell>
              <TableCell align="right">AnswerExpireDate</TableCell>
              <TableCell align="right">DocumentDate</TableCell>
          ...
          <TableBody>
            {this.props.list.map(row => (
              <TableRow key={row._id}>
                ...
                <TableCell align="right">{ row.AnswerDate }</TableCell>
                <TableCell align="right">{ row.AnswerExpireDate }</TableCell>
                <TableCell align="right">{ row.DocumentDate }</TableCell>
