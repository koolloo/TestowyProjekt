...
class DebtorList extends Component {
  ...
  confirmDialogDelete(id) {
    this.props.actionsDebtor.deleteDebtor(this.state.idDelete).then(data => {
      this.props.actionsDebtor.loadDebtorList();
      this.setState({ openDialogDelete: false, idDelete: null });
    });
  }
            ...
            {this.props.list.map(row => (
              <TableRow key={row._id}>
                <TableCell component="th" scope="row">
                  <Link to={"/debtors/" + row._id} key={row._id}>
                    {row._id}
                  </Link>
                </TableCell>
...
function mapStateToProps(state, ownProps) {
  return {
    list: state.DebtorListReducer.listDebtor
  };
}
